...
<div></div>
<div className="mdx-code-box">npx create-next-app --typescript 프로젝트명</div>

프로젝트가 생성되기 전에 여러가지 질문을 하는데

<br />
<div>1. typescript 사용할 거냐? Yes</div>
<div>2. tailwind 사용할 거냐? Yes</div>
<div>3. src 폴더 안에 넣을 거냐? Yes</div>
<br />
